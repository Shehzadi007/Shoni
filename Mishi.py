...
➣ Coder   : Faisal X Mishal
➣ Github  : https://github.com/Mishi007
➣ Facebook: Mishal Khan Mishi
➣ Whatsap: +923035191880
...
def login():
	...
	try:
		...
		os.system("clear")
		print (banner)
		Mishi('[+] Login Your Facebook Account')
		Mishi('[!] Donot Use Your Personal Account')
		Mishi('[!] Use a New Facebook Account To Login')
		print'-------------------------------------'
